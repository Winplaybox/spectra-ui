...
export const FilledBarcodeIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', fillOpacity, className, ...props }) => (
...
FilledBarcodeIcon.displayName = 'FilledBarcodeIcon';
export const BarcodeFilledIcon = FilledBarcodeIcon;
