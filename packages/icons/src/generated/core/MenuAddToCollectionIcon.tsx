...
export const MenuAddToCollectionIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
  ...
  <svg
    ...
    {...props}
  >
    <path d="M14 18H22" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="square" strokeLinejoin="round"/>
<path d="M18 14V22" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="square" strokeLinejoin="round"/>
...
MenuAddToCollectionIcon.displayName = 'MenuAddToCollectionIcon';
