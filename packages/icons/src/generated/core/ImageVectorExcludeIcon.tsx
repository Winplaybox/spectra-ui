...
export const ImageVectorExcludeIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M16 8H8V16H16V8Z" fill={color || 'currentColor'}/>
  </svg>
);

ImageVectorExcludeIcon.displayName = 'ImageVectorExcludeIcon';
