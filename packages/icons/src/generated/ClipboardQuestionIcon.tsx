...
export const ClipboardQuestionIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M12 18H12.01" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M10 12.04C10.04 11.75 10.16 11.21 10.56 10.73C10.66 10.6 10.85 10.37 11.18 10.2C11.58 10 11.94 10 12.1 10C12.28 10 12.71 10.02 13.15 10.31C13.69 10.67 13.86 11.19 13.91 11.35C13.94 11.43 14.1 11.96 13.91 12.56C13.8 12.94 13.6 13.18 13.43 13.39C12.73 14.22 12.11 14.15 12 14.69C11.99 14.71 12 14.82 12 15" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

ClipboardQuestionIcon.displayName = 'ClipboardQuestionIcon';
