...
export const MediaCirclePlaySlashIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M19.0699 19.0699L4.92993 4.92993" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="round" strokeLinejoin="round"/>
...
MediaCirclePlaySlashIcon.displayName = 'MediaCirclePlaySlashIcon';
