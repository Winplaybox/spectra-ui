...
export const CameraSurveillance2Icon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<circle cx="9" cy="13" r="3" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5}/>
  </svg>
);

CameraSurveillance2Icon.displayName = 'CameraSurveillance2Icon';
