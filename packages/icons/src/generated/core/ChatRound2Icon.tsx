...
export const ChatRound2Icon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M12 7.55006C12.81 6.23006 14.32 5.69006 15.42 6.18006C16.26 6.56006 17.02 7.60006 16.79 8.64006C16.66 9.24006 16.25 9.62006 15.93 9.88006C15.04 10.6601 13.73 11.7401 12 13.0001H17.44" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

ChatRound2Icon.displayName = 'ChatRound2Icon';
