...
export const MediaAutoplaySlashIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M9 7.99998V16C9 16.39 9.41 16.63 9.75 16.44L16.75 12.44C17.09 12.25 17.09 11.76 16.75 11.57L9.75 7.56998C9.41 7.37998 9 7.61998 9 7.99998Z" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="round" strokeLinejoin="round"/>
<path d="M2 2L22 22" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

MediaAutoplaySlashIcon.displayName = 'MediaAutoplaySlashIcon';
