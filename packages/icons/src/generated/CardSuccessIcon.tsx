...
export const CardSuccessIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M14.6 16.3499L16.4 18.1499L19.4 15.1499" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10"/>
  </svg>
);

CardSuccessIcon.displayName = 'CardSuccessIcon';
