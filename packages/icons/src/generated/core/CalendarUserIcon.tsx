...
export const CalendarUserIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
  ...
  <svg
    ...
    {...props}
  >
    <path d="M20 13C19.17 12.37 18.13 12 17 12C14.24 12 12 14.24 12 17C12 18.13 12.37 19.17 13 20H4C2.9 20 2 19.1 2 18V9V6C2 4.9 2.9 4 4 4H18C19.1 4 20 4.9 20 6V9V13Z" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M18 19H16C15.72 19 15.5 18.78 15.5 18.5C15.5 18.22 15.72 18 16 18H18C18.28 18 18.5 18.22 18.5 18.5C18.5 18.78 18.28 19 18 19Z" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M16.99 15.5H17" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M17 16C17.2761 16 17.5 15.7761 17.5 15.5C17.5 15.2239 17.2761 15 17 15C16.7239 15 16.5 15.2239 16.5 15.5C16.5 15.7761 16.7239 16 17 16Z" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
