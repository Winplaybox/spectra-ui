...
export const SharpBarcodeIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', fillOpacity, className, ...props }) => (
...
SharpBarcodeIcon.displayName = 'SharpBarcodeIcon';
export const BarcodeSharpIcon = SharpBarcodeIcon;

export const SharpQrcodeIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', fillOpacity, className, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
...
SharpQrcodeIcon.displayName = 'SharpQrcodeIcon';
export const QrcodeSharpIcon = SharpQrcodeIcon;
