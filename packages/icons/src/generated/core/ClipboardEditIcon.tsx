...
export const ClipboardEditIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M12.84 11.1L10.36 15.39L10.3 16.5L11.22 15.89L13.7 11.6L12.84 11.1Z" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round"/>
  </svg>
);

ClipboardEditIcon.displayName = 'ClipboardEditIcon';
