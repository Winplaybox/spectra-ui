      ...
      >
        ...
        {platform === 'macos' && (
          ...
          >
            ...
            <span style={{ fontSize: 12, fontWeight: 500, color: 'var(--color-text-muted)' }}>{title}</span>
            <div style={{ width: 45 }} />
          </div>
        )}
        ...
        {platform === 'windows' && (
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, color: 'var(--color-text-muted)' }}>
        ...
        {platform === 'ios' && (
          ...
          >
            <span style={{ fontSize: 13, fontWeight: 700, color: 'inherit' }}>9:41</span>
            {/* Dynamic Island pill */}
            <div
              style={{
                width: 90,
            ...
            />
            <div style={{ display: 'flex', gap: 6, alignItems: 'center', color: 'inherit' }}>
        ...
        {platform === 'android' && (
          ...
          >
            <span style={{ fontSize: 12, fontWeight: 600, color: 'inherit' }}>10:30</span>
            {/* Camera cutout */}
            <div
              style={{
                width: 10,
            ...
            />
            <div style={{ display: 'flex', gap: 8, alignItems: 'center', color: 'inherit' }}>
        ...
        {platform === 'ios' && (
          <div style={{ height: 24, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ width: 110, height: 4, borderRadius: 2, backgroundColor: 'var(--color-border-strong)' }} />
          </div>
        )}
        ...
        {platform === 'android' && (
          <div style={{ height: 20, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ width: 72, height: 3, borderRadius: 2, backgroundColor: 'var(--color-border-strong)' }} />
          </div>
        )}
      </div>
    );
