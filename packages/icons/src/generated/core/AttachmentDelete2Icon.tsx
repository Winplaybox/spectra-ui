...
export const AttachmentDelete2Icon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
  ...
  <svg
    ...
    {...props}
  >
    <path d="M14.83 6.34003L6.33998 14.83C4.77998 16.39 4.77998 18.92 6.33998 20.49C7.89998 22.05 10.43 22.05 12 20.49L20.49 12" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
AttachmentDelete2Icon.displayName = 'AttachmentDelete2Icon';
