...
export const ChatRoundQuotesRightIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M10 8V8.03C10 8.1 10 8.17 9.99 8.23C9.93 10.66 8.77 12.53 7 13" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M18 8V8.03C18 8.1 18 8.17 17.99 8.23C17.93 10.66 16.77 12.53 15 13" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
ChatRoundQuotesRightIcon.displayName = 'ChatRoundQuotesRightIcon';
