...
export const VideoSuccessIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M4.59998 14.35L6.39998 16.15L9.39998 13.15" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10"/>
  </svg>
);

VideoSuccessIcon.displayName = 'VideoSuccessIcon';
