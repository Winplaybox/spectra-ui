...
export const CameraSurveillance3Icon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<circle cx="12" cy="13" r="3" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5}/>
  </svg>
);

CameraSurveillance3Icon.displayName = 'CameraSurveillance3Icon';
