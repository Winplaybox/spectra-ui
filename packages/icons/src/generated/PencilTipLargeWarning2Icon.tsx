...
export const PencilTipLargeWarning2Icon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M18 1V4" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinejoin="round"/>
...
PencilTipLargeWarning2Icon.displayName = 'PencilTipLargeWarning2Icon';
