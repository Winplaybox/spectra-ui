...
export const CreditCardNFCDoubleIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M4.5 13.5H9" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="round"/>
<path d="M12.5627 17.3908C12.8373 17.0034 13 16.5218 13 16C13 15.4782 12.8373 14.9966 12.5627 14.6092" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="round" strokeLinejoin="round"/>
<path d="M11 16.5L11 15.5" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="round" strokeLinejoin="round"/>
<path d="M14.125 18.4531C14.6696 17.7993 15 16.9406 15 16C15 15.0594 14.6696 14.2007 14.125 13.5469" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="round" strokeLinejoin="round"/>
...
CreditCardNFCDoubleIcon.displayName = 'CreditCardNFCDoubleIcon';
