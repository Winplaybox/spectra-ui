...
export const MediaGoBackward30Icon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M7 9C7 9 8.1 9 9 9C11.1 9 11 12 9 12" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M7 15.25C7.5 15.5 8 16 9 16C10.5 16 11 14 10.5 12.995C10.5 13 10 12 9 12" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

MediaGoBackward30Icon.displayName = 'MediaGoBackward30Icon';
