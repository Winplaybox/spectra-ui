...
export const RotateLockSlashIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M14 11V9C14 7.34315 12.6569 6 11 6C9.34315 6 8 7.34315 8 9V11" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeLinecap="round" strokeLinejoin="round"/>
...
RotateLockSlashIcon.displayName = 'RotateLockSlashIcon';
