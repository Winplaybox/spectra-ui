...
export const PlusCircleIcon: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path d="M12 20C11.72 20 11.5 19.78 11.5 19.5V4.5C11.5 4.22 11.72 4 12 4C12.28 4 12.5 4.22 12.5 4.5V19.5C12.5 19.78 12.28 20 12 20Z" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
