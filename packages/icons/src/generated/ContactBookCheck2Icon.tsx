...
export const ContactBookCheck2Icon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M17.6 3.35002L19.4 5.15002L22.4 2.15002" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10"/>
  </svg>
);

ContactBookCheck2Icon.displayName = 'ContactBookCheck2Icon';
