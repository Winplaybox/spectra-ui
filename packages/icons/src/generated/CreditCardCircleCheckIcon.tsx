...
export const CreditCardCircleCheckIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M15 16.2L16.8 18L19.8 15" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10"/>
  </svg>
);

CreditCardCircleCheckIcon.displayName = 'CreditCardCircleCheckIcon';
