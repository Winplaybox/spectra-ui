...
export const CreditCardPlusIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M14 17H20" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.2} strokeMiterlimit="10" strokeLinejoin="round"/>
<path d="M17 14V20" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.2} strokeMiterlimit="10" strokeLinejoin="round"/>
