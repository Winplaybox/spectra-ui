...
export const FileMultiple2Icon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
...
<path d="M10 6H13" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M17 2V7H22V6.41C22 6.15 21.89 5.89 21.71 5.71L18.29 2.29C18.11 2.11 17.85 2 17.59 2H17Z" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

FileMultiple2Icon.displayName = 'FileMultiple2Icon';
