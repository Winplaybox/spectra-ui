...
export const ContactBookUnknownContactIcon: React.FC<IconProps> = ({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  className,
  ...
  <svg
    ...
    {...props}
  >
    <path d="M17 22H4V2H22V11" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M15.73 18H8V17C8 14.24 10.24 12 13 12C14.16 12 15.22 12.39 16.07 13.06C15.51 13.8 15.16 14.68 15.03 15.63C14.91 16.52 15.19 17.37 15.73 18Z" stroke={color || 'currentColor'} strokeWidth={strokeWidth ?? 1.5} strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
ContactBookUnknownContactIcon.displayName = 'ContactBookUnknownContactIcon';
